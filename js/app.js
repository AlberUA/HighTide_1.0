    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".testimonials__slider")) new swiper_core_Swiper(".testimonials__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".testimonials__slider-button_prev",
                    nextEl: ".testimonials__slider-button_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".blog-home__slider")) new swiper_core_Swiper(".blog-home__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".blog-home__slider-button_prev",
                    nextEl: ".blog-home__slider-button_next"
                },
                on: {}
            });
        }
